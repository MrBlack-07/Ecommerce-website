...
import authRoutes from "./routes/auth.js"; // 👈 Your new auth logic
...
// Auth routes
app.use("/api/auth", authRoutes); // 👈 Mounts /signup and /login

// Root route
app.get("/", (req, res) => {
  res.send("Welcome to the E-commerce API deployed on Railway!");
});
